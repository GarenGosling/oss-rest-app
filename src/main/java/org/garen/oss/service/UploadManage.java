...
public class UploadManage {
    ...
    public Map<String, Object> upload(MultipartFile multipartFile, FileType fileType) {
        ...
        if("picture".equals(fileInfoParam.getCategory())
            ...
            try {
                cacheThumbnailImage = createThumbnailImage(multipartFile, fileInfoParam.getCategory(), fileInfoParam.getType(), fileInfoParam.getMd5());
            } catch (IOException e) {
...
//            FileUtil.deleteFile(cacheThumbnailImage);
     ...
     * @return
     */
    public File createThumbnailImage(MultipartFile file, String category, String type, String md5) throws IOException, PDFException, PDFSecurityException, InterruptedException {
        ...
        if("picture".equals(category)){
            ...
            document.setInputStream(file.getInputStream(), null);
