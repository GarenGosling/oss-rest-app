...
import org.garen.oss.swagger.model.User;
...
public interface UserApi {
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful oss", response = Void.class) })
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful oss", response = User.class),
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful oss", response = String.class),
