...
import org.garen.oss.swagger.model.Order;
...
public interface StoreApi {
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful oss", response = Integer.class) })
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful oss", response = Order.class),
