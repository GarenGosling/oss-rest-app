...
public interface FileTypeApi {
    ...
    @ApiOperation(value = "删除文件类型", notes = "删除文件类型 ", response = SuccessModel.class, tags={  })
    @ApiResponses(value = { 
    ...
    ResponseEntity<SuccessModel> deleteFileType(@ApiParam(value = "文件类型ID") @RequestParam(value = "id", required = false) Long id);
    ...
    @RequestMapping(value = "/fileType/name",
        method = RequestMethod.GET)
    ResponseEntity<SuccessModel> getByName(@ApiParam(value = "文件类型名称") @RequestParam(value = "name", required = false) String name);


    @ApiOperation(value = "分页查询文件类型", notes = "分页查询文件类型 ", response = SuccessModel.class, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response", response = SuccessModel.class),
        @ApiResponse(code = 200, message = "unexpected error", response = SuccessModel.class) })
    ...
    @RequestMapping(value = "/fileType",
        method = RequestMethod.GET)
    ResponseEntity<SuccessModel> getFileType(@ApiParam(value = "文件类型ID") @RequestParam(value = "id", required = false) Long id);


    @ApiOperation(value = "新增文件类型", notes = "新增文件类型 ", response = SuccessModel.class, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response", response = SuccessModel.class),
        @ApiResponse(code = 200, message = "unexpected error", response = SuccessModel.class) })
    @RequestMapping(value = "/fileType",
    ...
    ResponseEntity<SuccessModel> saveFileType(@ApiParam(value = "文件类型") @RequestBody FileType fileType);


    @ApiOperation(value = "修改文件类型", notes = "修改文件类型 ", response = SuccessModel.class, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response", response = SuccessModel.class),
        @ApiResponse(code = 200, message = "unexpected error", response = SuccessModel.class) })
    @RequestMapping(value = "/fileType",
