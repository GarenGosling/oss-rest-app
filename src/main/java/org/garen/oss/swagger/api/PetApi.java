...
import org.garen.oss.swagger.model.ModelApiResponse;
import org.garen.oss.swagger.model.Pet;
...
public interface PetApi {
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful oss", response = Pet.class),
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful oss", response = ModelApiResponse.class) })
